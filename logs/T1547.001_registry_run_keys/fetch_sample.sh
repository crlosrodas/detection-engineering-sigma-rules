#!/usr/bin/env bash
#
# fetch_sample.sh - Download the T1547.001 (Registry Run Keys) sample log on demand.
#
...
# But the uncompressed JSON is ~80 MB (40,569 events of ambient host telemetry
# around the couple of Run-key writes), large enough that committing it heavily
# bloats the git history for every future clone. So instead we:
...
FILENAME="empire_persistence_registry_modification_run_keys_standard_user_2020-09-04030609.json"
...
EXPECTED_SHA256="9a781f7c44c2f625c6eb66f673261d7820a7c8d662dc9c91668acd50e51b9725"
...
echo "[*] Downloading T1547.001 Registry Run Keys sample (MIT; fetched for repo size)..."
echo "    from: ${URL}"
echo "    to:   ${OUT_FILE}"
